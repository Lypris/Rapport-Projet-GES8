...
\usepackage{rotating}               % Pour rotation de figures (sidewaysfigure)
\usepackage[table]{xcolor}                 % Pour utiliser des couleurs (option `table` active \cellcolor/colortbl)
...
% Charger siunitx explicitement et forcer la virgule comme séparateur décimal
\usepackage{siunitx}
...
% Macro pour décision retenue
\newtcolorbox{decisionbox}[1][Décision retenue]{
    colback=conclusionbg,
    colframe=conclusioncolor,
    coltitle=white,
    colbacktitle=conclusioncolor,
...
% Macro pour Trace de raisonnement standardisé
\newtcolorbox{tracebox}[1][Dimensionnement du convertisseur]{
    colback=calculbg,
    colframe=gray,
    coltitle=white,
    colbacktitle=gray,
