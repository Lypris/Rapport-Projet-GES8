...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/03_dual_boost_T_petit_signaux1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/04_dual_boost_T_petit_signaux_2.png}
