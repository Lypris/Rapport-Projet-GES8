...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/01_Schema_hacheur_entrelace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/02_Schema_hacheur_dual_boost_T.png}
...
\begin{tabular}{@{}p{0.47\textwidth}!{\color{remindercolor}\vrule width 1pt}p{0.47\textwidth}@{}}
    \centering
    \includegraphics[width=0.45\textwidth]{images/Partie Rice cooker/03_dual_boost_T_petit_signaux1.png}
    \captionsetup{hypcap=false}
    \captionof{figure}{Schéma d'étude entre $0$ et $\alpha T$}
    ...
    &
    \centering
    \includegraphics[width=0.45\textwidth]{images/Partie Rice cooker/04_dual_boost_T_petit_signaux_2.png}
    \captionsetup{hypcap=false}
    \captionof{figure}{Schéma d'étude entre $\alpha T$ et $T/2$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/05_Schema_hacheur_entrelace_PSIM.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/06_Simulation_puissance_sortie_Hacheur_entrelace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/07_Simulation_courant_et_tension_dans_la_bobine___hacheur_entrelace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/08_Ice_hacheur_entrelace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/09_Ics_hacheur_entrelace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/10_It1_hacheur_entrelace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/11_ID1_VT1_hacheur_entrelace.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/12_Schema_hacheur_dual_boost_simulation.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/13_Puissance_charge_sans_rampe.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/14_Puissance_charge_avec_rampe.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/15_Ice_d.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/20_bobine_caracteristiques.png}
    \caption{Caractéristiques bobine L1.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/Partie Rice cooker/21_bobine_aspect_exterieur.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/22_capacite_d_entree.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/23_Capacite_de_sortie.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/24_Filtre_classe_A_5_15.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/25_Courbe_chute_capacite_en_fonction_de_la_tension___5_15_filtre_.PNG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{images/Partie Rice cooker/26_SCHEMA_PROTEUS_VERSION1.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/27_PCB_VERSION_1.PNG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie Rice cooker/28_Schema_contact_rice_cooker.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie luminaires/01_Schema_filtre_CEM.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/Partie luminaires/02_Schema_proteus.pdf}
        \caption{Filtre et convertisseur (Proteus).}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/Partie luminaires/03_Routage_du_filtre_du_convertisseur_pour_les_luminaires.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/01_Schema_d_application_typique_du_LM5116_illustrant_le_pilotage_integre_des_MOSFETs_de_puissance__Source___Datasheet_Texas_Instruments_.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/02_Schema_de_simulation_PSIM_du_convertisseur_Buck_Synchrone_avec_les_valeurs_theoriques_calculees.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/03_Releves_de_la_simulation_theorique__Tension_de_sortie_V_Cs__en_rouge__Courant_d_inductance_I_L__en_vert_.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/04_Modele_PSIM_realiste_integrant_l_asservissement_PI__les_temps_morts_et_les_elements_parasites.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/05_Zoom_sur_les_signaux_de_commande_des_MOSFETs_illustrant_le_Temps_Mort__Dead-Time__.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/06_Releves_en_regime_permanent_du_convertisseur_avec_boucle_de_regulation__Courant_d_inductance__Tension_d_entree_et_Tension_de_sortie_.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/07_Schema_Webench_complet_integrant_l_integralite_des_composants_passifs_peripheriques_.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/08_Reference_du_convertisseur_DC_DC_5V_vers_12V__Farnell__utilise_pour_l_alimentation_logique_.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/09_Simulation_de_l_ondulation_de_la_tension_de_sortie__Vout__et_du_courant_capacitif__Icout__en_regime_permanent_sous_5A.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/10_Reponse_de_la_tension__Vout__face_a_un_changement_brutal_du_courant_demande__Iout_.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{images/Partie USB-C/11_Schema_USB-C.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/12_PCB_carte_USB-C.png}
...
\end{decisionbox}
    ...
    \section{USB-B}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{images/Partie USB-B/01_Schema_extrait_de_la_datasheet.png}
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{images/Partie USB-B/02_Schema_proteus.pdf}
...
\end{decisionbox}
    ...
    \section{Alimentation de la logique de commande}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{images/Partie Filtre ALIM/01_Schema_extrait_de_la_datasheet.png}
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[b]{0.48\textwidth}
                \centering
                \includegraphics[width=\linewidth]{images/Partie Filtre ALIM/02_Schema_Proteus.pdf}
