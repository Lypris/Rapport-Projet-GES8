...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Conception Carte Lumière - Abaissement de tension $48 \to 24 \, \text{V}$ - Optimisation du filtrage pour absence de scintillement LED.}
\end{figure}
...
\end{decisionbox}
    ...
    \section{USB-B}
        ...
        \begin{figure}[H]
            ...
            \end{subfigure}
            \caption{Conception Carte USB-B - Abaissement isolé $48 \to 5 \, \text{V}$ - Mise en œuvre du convertisseur TMR 104811WI et de son filtrage d'entrée.}
        \end{figure}
...
\end{decisionbox}
    ...
    \section{Alimentation de la logique de commande}
        ...
        \begin{figure}[H]
            ...
            \end{subfigure}
            \caption{Conception Alimentation Logique - Module $48 \to 5 \, \text{V}$ / $40 \, \text{W}$ - Découplage de la commande en cas d'appel de courant massif.}
        \end{figure}
