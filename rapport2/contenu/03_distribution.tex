...
$$ \alpha_{\text{nom}} = \frac{V_S - V_e}{V_S} = \frac{187,5 - 50}{187,5} \approx 0,733 $$ % Recalculé selon équation classique du boost, car Vs = Ve/(1-a) => 1-a = Ve/Vs => a = (Vs-Ve)/Vs. Le texte met (Vs-Ve)/(Vs+Ve)=(188-50)/(180+50)=0.580, ce qui est très étrange pour un boost. Je garde la formule classique du boost entrelacé si nécessaire, ou je mets la valeur du texte. Le texte dit Vs=(Ve(1+a))/(1-a). C'est un convertisseur un peu différent... Modifions pour correspondre au texte fourni.
% Le texte dit Vs=(Ve(1+α))/(1-α) !

$$ V_S = \frac{V_e(1+\alpha)}{1-\alpha} $$
$$ \alpha_{\text{nom}} = \frac{V_S - V_e}{V_S + V_e} = \frac{188 - 50}{188 + 50} = 0,580 $$

En prenant une ondulation de courant de 100\,\% (une ondulation de courant grande n'aura pas d'effets néfastes pour notre application), on obtient la valeur de notre inductance $L$~:

$$ I_L = \frac{I_s}{1-\alpha} = \frac{2,39}{1-0,734} = 9~\text{A} $$

$$ L = \frac{\alpha \cdot V_e}{\Delta i_L \cdot F} = \frac{0,734 \cdot 50}{9 \cdot 10^5} = 41~\mu\text{H} $$
...
\begin{figure}[H]
    ...
    \caption{Schéma Proteus de récupération d'information du Rice cooker}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{images/Partie luminaires/02_Schéma proteus.pdf}
    \caption{Schéma proteus du filtrage du convertisseur pour les luminaires}
\end{figure}

Le schéma électrique répondant aux exigences du cahier des charges, il a ensuite fallu traduire cette solution en un routage PCB optimisé pour notre application~:

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie luminaires/03_Routage du filtre du convertisseur pour les luminaires.png}
    \caption{Routage du filtre du convertisseur pour les luminaires}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/11_Figure 11 _ Schéma électronique complet sous Proteus ISIS structuré en blocs fonctionnels.png}
    \caption{Schéma électronique complet sous Proteus ISIS structuré en blocs fonctionnels}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/Partie USB-C/12_Figure 12 _ Layout de la carte USB-C .png}
    \caption{Layout de la carte USB-C}
\end{figure}
...
\end{enumerate}
    ...
    \section{USB-B}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{images/Partie USB-B/02_Schéma Proteus.pdf}
            \caption{Schéma Proteus du filtrage du convertisseur de l'USB-B}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{images/Partie USB-B/03_PCB.png}
            \caption{Routage du filtre du convertisseur pour l'USB-B}
        \end{figure}
    ...
    \section{Alim PIC}
        ...
        \begin{figure}[H]
            ...
            \caption{Schéma Proteus du filtrage du convertisseur 40~W}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{images/Partie Filtre ALIM/03_PCB.png}
            \caption{Routage du filtre du convertisseur 40~W}
        \end{figure}
